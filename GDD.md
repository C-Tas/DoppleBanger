...
- **Teclas de habilidad:** utiliza una [habilidad](#skills). Se usarán 3 teclas por defecto, no configurables, que se pueden asignar a distinas habilidades. Además existe una cuarta tecla que solo podrá asignar habilides de la rama del clon.
