...
void SaveState::initState()
{
	...
	createButton2(saveSlot1, app_, app_->getTextureManager()->getTexture(Resources::SaveGame1), posButton, scaleButton);

	//Botón partida 2
	posButton = posButton + Vector2D(0, winHeight / 4);
	createButton2(saveSlot2, app_, app_->getTextureManager()->getTexture(Resources::SaveGame2), posButton, scaleButton);

	//Botón partida 3
	posButton = posButton + Vector2D(0, winHeight / 4);
	createButton2(saveSlot3, app_, app_->getTextureManager()->getTexture(Resources::SaveGame3), posButton, scaleButton);
}
