...
private:
	...
	//ANIM
	int frameAction_ = 0;					//Frame en el que se realiza la acci�n
	const int W_BONE_FRAME = 15;			//Ancho del frame, est�ndar para todas
	const int H_BONE_FRAME = 15;			//Alto del frame, est�ndar para todas

	//Idle
	const int BONE_FRAME = 6;
	//Idle derecha
	const int BONE_FRAMES = 8;			//Frames de la animaci�n
