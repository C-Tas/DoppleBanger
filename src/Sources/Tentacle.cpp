...
{
	Anim spawnAnim_ = Anim(NUM_FRAMES_SPAWN, NUM_FRAMES_ROW_SPAWN, W_FRAME_SPAWN, H_FRAME_SPAWN, FRAME_RATE_SPAWN, NAME_SPAWN);
	Anim idleAnim_ = Anim(NUM_FRAMES_IDLE, NUM_FRAMES_ROW_IDLE, W_FRAME_IDLE, H_FRAME_IDLE, FRAME_RATE_IDLE, NAME_IDLE);
	Anim despawnAnim_ = Anim(NUM_FRAMES_DESPAWN, NUM_FRAMES_ROW_DESPAWN, W_FRAME_DESPAWN, H_FRAME_DESPAWN, FRAME_RATE_DESPAWN, NAME_DESPAWN);
}
