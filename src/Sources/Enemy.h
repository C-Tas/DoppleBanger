...
protected:
	...
	virtual void doDamage() {/*Cuando el jugador tenga metodos para recibir daño habría que definir este metodo con un app__>getPlayer()->getDamage(currStats_.ad_) */ };
public:
