...
void MainMenuState::createButtons() {
	...
	Button* b = new Button(app_, new Texture(app_->getRenderer(), "../Sources/assets/timon.png"), { 50,50 }, { 50,50 }, goControlState);
	gameObjects_.push_back(b);
	objectsToRender_.push_back(b);
	//creamos el boton para ir a los creditos
	Button* b1 = new Button(app_, new Texture( app_->getRenderer(), "../Sources/assets/timon.png"), { 150,50 }, { 50,50 }, goCreditsState);
	...
	Button* b2 = new Button(app_, new Texture(app_->getRenderer(), "../Sources/assets/timon.png"), { 50,150 }, { 50,50 }, goLoadState);
	...
	Button* b3 = new Button(app_,new Texture(app_->getRenderer(), "../Sources/assets/timon.png"), { 150,150 }, { 50,50 }, goStoryState);
