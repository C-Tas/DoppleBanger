...
public:
	...
	///<summary>Aumenta los punto invertidos en la rama Precision</summary>
	static void increasePrecisionBranch(Application* app);
	///<summary>Aumenta los punto invertidos en la rama Melee</summary>
	static void increaseMeleeBranch(Application* app);
	///<summary>Aumenta los punto invertidos en la rama Ghost</summary>
